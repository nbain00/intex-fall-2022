...
class Food(models.Model) :
    ...
    ca_g = models.DecimalField(max_digits=8, decimal_places=2)
    phos_g = models.DecimalField(max_digits=8, decimal_places=2)
    k_g = models.DecimalField(max_digits=8, decimal_places=2)
    na_g = models.DecimalField(max_digits=8, decimal_places=2)
